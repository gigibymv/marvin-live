...
_PHASE_NARRATION: dict[str, str] = {
    ...
    "research_done": "Research pass complete; preparing the manager review checkpoint.",
    ...
    "synthesis_done": "Synthesis pass complete; preparing the final review checkpoint.",
